...
export class WebDService {
    ...
    public move_to_order(_orderDetails: orderDetails) {
        return this._base._apiService.post(`${ApiConstant.product.move_to_order}`, _orderDetails);
    }
}