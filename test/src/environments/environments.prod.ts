...
export const environment = {
    ...
    appHTMLIntegration: 'https://preview.apnasociety.com/metronic8/demo1/documentation/base/helpers/flex-layouts.html',
    appPreviewUrl: 'https://preview.apnasociety.com/metronic8/angular/demo1/',
    appPreviewAngularUrl: 'https://preview.apnasociety.com/metronic8/angular/demo1',
    appPreviewDocsUrl: 'https://preview.apnasociety.com/metronic8/angular/docs',
    appPreviewChangelogUrl: 'https://preview.apnasociety.com/metronic8/angular/docs/changelog',
    appDemos: {
      'demo1': {
        'title': 'Demo 1',
